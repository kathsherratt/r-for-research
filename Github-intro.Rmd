...
- If Git has not yet been installed, you might see something like `git: command not found`. In this case:
  ...
  - If nothing happens, go to the [Git website](https://git-scm.com/downloads) and select the version which is compatible with the OS of your computer (e.g. Windows/Mac/Linux/Solaris). Follow the instructions to download and install
...
- Go to [Github Desktop](https://desktop.github.com/) and follow the download instructions
...
Let's link the repository you created online to Github Desktop so you can track it locally. 

- On the webpage of your repository, press the green "Code" button > "Open with Github Desktop".

- Make a change in the RProject to test how Github works. 
  - For example, within your RProject environment, create a new script and save it.   

- Switch windows back to Github Desktop: you should see your new script under the "Changes" tab. Stay in Github Desktop to push this to the Github remote (website).
  - Create a commit: write a short message to summarise your change in the bottom-left box and press "Commit to main"
  - Push to Github: in the top bar, press "Push origin"

- Now switch back to your web browser to check your new script has been uploaded to Github remote storage.


## Continue learning Github

There are tons of resources for using Github with R and RStudio. They can get quite technical but you've got the basics already. Here are a couple of good guides to keep going with Github:
