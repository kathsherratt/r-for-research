...
For practice, try creating something new in the RProject - for example, create a new script and save it. Then switch windows back to Github Desktop: you should see your new script under the "Changes" tab. 
- Create a commit: write a short message and press "Commit to main"
- Push to Github: 
