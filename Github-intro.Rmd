...
You'll need to authenticate yourself in order to connect the Git you now have on your computer to the online repo. This is done using a Personal Access Token (similar to a password).
